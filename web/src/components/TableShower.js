...
const { FormRow, InputFormField, OtherFormField, Validators, 
    ButtonGroupFormField, TableFormField } = Form;
...
class TableShower extends Component {
  ...
  render() {
    ...
    console.log(columns)
    columns.concat([{ dataKey: 'action1',
    title: '操作',
    width: 100,
    type: 'action',
    actions: {
      ...
      const tableProps = {
      width: 1000,
      // fetchUrl: new Product().link, //todo
