...
module.exports = function (webpackEnv) {
  ...
  function setup() {
    const entry = {};
    const plugins = [
      // // Generates an `index.html` file with the <script> injected. new
      // HtmlWebpackPlugin(   Object.assign(     {},     {       inject: true,
      // template: paths.appHtml,     },     isEnvProduction       ? {
      // minify: {             removeComments: true,             collapseWhitespace:
      // true,             removeRedundantAttributes: true,
      ...
      // true,           },         }       : undefined   ) ), Inlines the webpack
      // runtime script. This script is too small to warrant a network request.
    ...
    const key = paths.pagename
    entry[key] = [
      //require.resolve('./polyfills'),
      require.resolve('react-dev-utils/webpackHotDevClient'),
      resolveApp('./src/page/' + key) + '/index.js'
    ]

    const newPlugins = new HtmlWebpackPlugin(Object.assign({}, {
      chunks: [key],
      inject: true,
  ...
  return {
    ...
    optimization: {
      ...
      // https://medium.com/webpack/webpack-4-code-splitting-chunk-graph-and-the-splitc
      // hunks-optimization-be739a861366
      splitChunks: {
        chunks: 'all',
        name: false
      },
